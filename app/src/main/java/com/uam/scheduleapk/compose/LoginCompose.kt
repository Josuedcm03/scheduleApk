...
fun LoginCompose(loginViewModel: LoginViewModel, modifier: Modifier){
        ...
        modifier = Modifier.fillMaxSize())
    {
        ...
        TextField(value = state.email, onValueChange = {loginViewModel.onEmailChange(it)},
            label = {Text(text = stringResource(id = R.string.email))}
        )
        Spacer(modifier = Modifier.height(5.dp))
        TextField(value = state.password, onValueChange = {loginViewModel.onPasswordChange(it)},
